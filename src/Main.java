public class Main
{
    public static void main(String[] args) {
        ...
        System.out.println("The modulo" + intOperandA + " and " + intOperandB + " is " + intModulo);


        // Complete this section

        double doubleOperandA = 3.14;
        double doubleOperandB = 2.14;
        ...
        System.out.println("the quotient " + doubleOperandA + " and " + doubleOperandB + " is " + doubleQuotient);
        doubleDifference = doubleOperandA - doubleOperandB;
        System.out.println("the difference " + doubleOperandA + " and " + doubleOperandB + " is " + doubleDifference);
